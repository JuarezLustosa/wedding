...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { description: @gift.description, image_path: @gift.image_path, path: @gift.path }
    end
  ...
  test "should update gift" do
    put :update, id: @gift, gift: { description: @gift.description, image_path: @gift.image_path, path: @gift.path }
    assert_redirected_to gift_path(assigns(:gift))
  end
